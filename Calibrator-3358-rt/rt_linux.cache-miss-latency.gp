...
# set output 'rt_linux.cache-miss-latency.ps'
...
set output 'rt_linux.cache-miss-latency.gif'
set style data linespoints
set key below
set title 'rt_linux.cache-miss-latency'
...
set y2tics ('(4)' 5.630000, '(233)' 323.400000, '0.72' 1, '7.2' 10, '72' 100, '720' 1000)
set label 1 '(5.56)  ' at 0.750000,5.555555 right
set arrow 1 from 0.750000,5.555555 to 40960.000000,5.555555 nohead lt 0
set label 2 '(324)  ' at 0.750000,323.611115 right
set arrow 2 from 0.750000,323.611115 to 40960.000000,323.611115 nohead lt 0
...
'rt_linux.cache-miss-latency.data' using 1:($7-146.120000) title '128' with linespoints lt 1 pt 3 , \
'rt_linux.cache-miss-latency.data' using 1:($13-146.120000) title '\{64\}' with linespoints lt 2 pt 4 , \
'rt_linux.cache-miss-latency.data' using 1:($19-146.120000) title '32' with linespoints lt 3 pt 5 , \
'rt_linux.cache-miss-latency.data' using 1:($25-146.120000) title '16' with linespoints lt 4 pt 6 , \
'rt_linux.cache-miss-latency.data' using 1:($31-146.120000) title '8' with linespoints lt 5 pt 7 , \
'rt_linux.cache-miss-latency.data' using 1:($37-146.120000) title '4' with linespoints lt 6 pt 8
set nolabel
set noarrow
